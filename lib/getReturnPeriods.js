...
var $ = require("jquery"); //**GLOBAL VARIABLES TO DEAL WITH THE FUNCTIONS**//
...
module.exports = {
  graph_rp: function (reachid, start, end, width, height, htmlELement) {
