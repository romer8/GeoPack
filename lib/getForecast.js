...
to add more customization for the style of the plot, so far it looks good for a simple plot**/
//*** REQUIRE LIBRARIES***///
...
var math = require('mathjs'); //**GLOBAL VARIABLES TO DEAL WITH THE FUNCTIONS**//
...
var returnShapes;
var endpoint = "https://tethys2.byu.edu/localsptapi/api/"; //** THIS FUNCTIONS RETRIEVES THE FORECAST DATA IN A GRAPH **//
...
module.exports = {
  ...
  downloadData: function (reachid) {
    console.log("enter the download function"); // THIS IS A FUNCTION TO DOWNLOAD DATA //

    var downloadUrl = endpoint + "ForecastEnsembles/?reach_id=" + reachid + "&return_format=csv"; // var downloadUrl="https://tethys2.byu.edu/localsptapi/api/"+"ForecastEnsembles/?reach_id="+reachid+"&return_format=csv";
  ...
  locationGraph_f: function (lat, lon, htmlELement, add, width, height) {
    width = typeof width !== 'undefined' ? width : 500;
    height = typeof heigth !== 'undefined' ? heigth : 500;
    add = typeof add !== 'undefined' ? add : false;
